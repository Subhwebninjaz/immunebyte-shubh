export default function ScaServicesBanner() {
  return (
    <>
    <section className="ScaServices-banner">
      <div className="container">
        <div className="row g-4 hb-row1">
          <div className="col-lg-7">
            <h1 className="sec-title main-title">Smart Contract Audit <span>Services</span></h1>
