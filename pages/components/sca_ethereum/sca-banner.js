export default function ScaEthereumBanner() {
  return (
    <>
    <section className="ScaEthereum-banner">
      <div className="container">
        <div className="row g-4 hb-row1">
          <div className="col-lg-7">
            <h1 className="sec-title main-title">Ethereum <span>Smart Contract Audit</span></h1>
