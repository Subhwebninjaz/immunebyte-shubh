export default function ScaAvalancheWhy() {
  return (
    <>
    <section className="sca-why-sec">
      <div className="container">
          <h2 className="sec-title">Why Should You Undergo Avalanche <span>Smart Contract Audit?</span></h2>
          ...
          <div className="sca-stats">
            <div className="hbs">
              <h2>$6B</h2>
              <h6>Total Value Lost To Hacks</h6>
            </div>
            <div className="hbs">
              <h2>$6B</h2>
              <h6>Total Value Lost To Hacks</h6>
