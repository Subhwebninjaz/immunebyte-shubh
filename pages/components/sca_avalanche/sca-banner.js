export default function ScaAvalancheBanner() {
  return (
    <>
    <section className="ScaAvalanche-banner">
      <div className="container">
        <div className="row g-4 hb-row1">
          <div className="col-lg-7">
            <h1 className="sec-title main-title">Avalanche <span>Smart Contract Audit</span></h1>
