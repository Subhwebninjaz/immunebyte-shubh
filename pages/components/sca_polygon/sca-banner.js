export default function ScaPolygonBanner() {
  return (
    <>
    <section className="ScaPolygon-banner">
      <div className="container">
        <div className="row g-4 hb-row1">
          <div className="col-lg-7">
            <h1 className="sec-title main-title">Polygon <span>Smart Contract Audit</span></h1>
