export default function ScaOptimismBanner() {
  return (
    <>
    <section className="ScaOptimism-banner">
      <div className="container">
        <div className="row g-4 hb-row1">
          <div className="col-lg-7">
            <h1 className="sec-title main-title">Optimism <span>Smart Contract Audit</span></h1>
